...
$(function () {
  $("[id^=bto]").on("change", function () {
    var form = document.getElementById('order_data_import');
    var select_btn_id = $(this).attr('id');
    var select_file = document.getElementById(select_btn_id);
    var select_file_split = select_file.value.split('\\');
    var import_type = document.getElementById('import_type');
    var shipment_category = document.getElementById('shipment_category'); // 処理を実行するか確認
